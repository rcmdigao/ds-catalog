...
public class ProductDTO implements Serializable {
    ...
    public ProductDTO(Product entitity) {
        this.id = entitity.getId();
        this.name = entitity.getName();
        this.description = entitity.getDescription();
        this.price = entitity.getPrice();
        this.imgUrl = entitity.getImgUrl();
        this.date = entitity.getDate();
    }
